            ...
            <div className="max-w-7xl mx-auto px-4 py-12 sm:px-6 lg:px-8">
                <div className="xl:grid xl:grid-cols-3 xl:gap-8">
                    <div className="space-y-8 xl:col-span-1">
                        <Link href="/" className="flex items-center">
                            ...
                            <div>
                                <h2 className="text-lg font-bold text-gray-900 dark:text-white">ProofWork</h2>
                                <p className="text-sm text-gray-500 dark:text-gray-400">Blockchain-Verified Freelancer Reputations</p>
                            </div>
                        </Link>
                        <p className="text-gray-500 dark:text-gray-400 text-sm max-w-xs">
                            ProofWork provides a decentralized platform for freelancers to build and showcase their verified reputation on the blockchain.
                        </p>
                        ...
                        <div className="md:grid md:grid-cols-2 md:gap-8">
                            <div>
                                ...
                                <ul className="mt-4 space-y-4">
                                    ...
                                    <li>
                                        <Link href="/clients" className="text-base text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white">
                                            Clients
                                        </Link>
                                    </li>
                                    <li>
                ...
                <div className="mt-12 border-t border-gray-200 dark:border-gray-700 pt-8">
                    <p className="text-base text-gray-400 text-center">
                        &copy; {new Date().getFullYear()} ProofWork, Inc. All rights reserved.
                    </p>
                </div>
            </div>
        </footer>
